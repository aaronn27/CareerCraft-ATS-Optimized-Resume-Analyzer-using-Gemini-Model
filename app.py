...
# Prompt Templete
input_prompt = """
Response as an experienced ATS (Applicant Tracking System), proficient in the technical domain encompassing
...
resumes against provided job descriptions. In a highly competitive job market, your expertise is crucial
in offering top-notch guidance for resumes. Assign precise itching percentages based on the .M
(Job Description) and meticulously identify any missing keywords with utmost accuracy.
Resume:{text}
Description:{jd}

I want the responses in the following structure:
...
with col2:
    ...
    st.write("""Answer: Yes, CareerCraft provides personalized recommendations to optimize your resune
